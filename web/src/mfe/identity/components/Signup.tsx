...
import { InputField, PasswordField } from '../../core/components/InputField';
              ...
              <Stack spacing={8} mx={'auto'} maxW={'lg'} py={12} px={6}>
                ...
                <Box
                  ...
                  <Stack spacing={4}>
                    ...
                    <Stack pt={6}>
                      <Text align={'center'}>
                        Already a user? <NextLink href={identityConfig.links["login"].href} as={identityConfig.links["login"].href}> Login </NextLink>
                      </Text>
                    </Stack>
                  </Stack>
                </Box>
