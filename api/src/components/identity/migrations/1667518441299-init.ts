...
export class init1667518441299 implements MigrationInterface {
    name = 'init1667518441299'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "oauth_clients" ("id" character varying NOT NULL, "secret" character varying(128), "name" character varying(128) NOT NULL, "redirectUris" text NOT NULL, "allowedGrants" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c4759172d3431bae6f04e678e0d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "oauth_auth_codes" ("code" character varying(128) NOT NULL, "userId" uuid, "clientId" character varying NOT NULL, "redirectUri" character varying, "codeChallenge" character varying(128), "codeChallengeMethod" character varying(128), "expiresAt" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_d40c87f888fba2e9fcaf77bef58" PRIMARY KEY ("code"))`);
        ...
        await queryRunner.query(`CREATE TABLE "oauth_client_scopes" ("clientId" character varying NOT NULL, "scopeId" integer NOT NULL, CONSTRAINT "PK_4418822562d4ad6e14804390f1f" PRIMARY KEY ("clientId", "scopeId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "oauth_auth_codes" ADD CONSTRAINT "FK_22541b7182ffa065fcd07e58c82" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "oauth_tokens" ADD CONSTRAINT "FK_a8c200cc4c90d24e832caf0a180" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
